        ...
        <div className={PersonnelsCSS.personnelContainer}>
            <div className={PersonnelsCSS.contents}>
                <div className={PersonnelsCSS.filterContainer}>
                    <form action="" method="" className={PersonnelsCSS.searchBar}>
                        ...
                        <button className={PersonnelsCSS.searchBtn}><SearchIcon fontSize='small'/></button>
                    </form>
                </div>
            </div>
            ...
            <div className={PersonnelsCSS.personnelTable}>
                <table>
                    <thead>
                        <tr>
                            <th> <CheckBoxIcon fontSize='small'/> </th>
                            <th> Name </th>
                            <th> Type </th>
                            <th> Date Created </th>
                            <th> Last Login </th>
                    ...
                    <tbody>
                        <tr>
                            <td> <CheckBoxOutlineBlankIcon fontSize='very small'/> </td>
                            <td> <Link to='/admin/personnel/personnelDetails'> Macel Galanido </Link> </td>
                            <td> Admin </td>
                            <td> 11/13/2023 </td>
                            <td> 11/23/2023 7:08 AM </td>
                            <td> Active </td>
                            <td> <MoreHorizIcon fontSize='small'/> </td>
                        </tr>
                    </tbody>
                </table>
            </div>
