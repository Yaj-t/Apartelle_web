            ...
            <div className={ReserveDetailsCSS.cardContainer}>
                <Card>
                  <div className={ReserveDetailsCSS.contentContainer}>
                    <img src="../../src/assets/Room_Picture.jpg" alt="room picture" id={ReserveDetailsCSS.reserveImg}/>
                    <div className={ReserveDetailsCSS.bodyContent}>
                      ...
                      <div className={ReserveDetailsCSS.details}>
                        <p> <b> Name of Client: </b> Marc Nelson Ochavo</p>
                        <p> <b> No. of Adults: </b> 2</p>
                        <p> <b> No. of Children: </b> 3 </p>
                        <p> <b> Reserved Day: </b> 11/23/23 </p>
                        <p> <b> Check-out Day: </b> 12/23/23</p>
                        <p> <b> Payment: </b> Php 1,000.00 </p>
